  ...
  return (
    <Col key= {recipe["id"]}>
      ...
      <Card style={{border:"0px", margin:"10px"}}> 
        <Card.Img variant="top" src={recipe["image"]} className='img-overlay' style={{borderRadius:"20px"}}/>
        <Card.ImgOverlay>
          <Card.Body>
            <Row>
              ...
              <Col>
                ...
                <Button onClick={() => setOverlayData(<RecipeDetails id={recipe["id"]} />)}>See Recipe</Button>
                <Button onClick={()=>setter(oldArray => [...oldArray, recipe["id"]])}>Add to Array</Button>
                </div>
              </Col>

            </Row>
            <Card.Title style={{marginTop:"10px"}}>{recipe["title"]}</Card.Title>
            <Card.Text>
